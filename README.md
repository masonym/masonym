...
platform of tools for the MMORPG *MapleStory* used by 50k+ monthly players. built with next.js, javascript, and a custom ETL pipeline (c#/python) that parses thousands of in-game items from raw client files. currently the project i enjoy the most, and as a result, spend the most time on. always thinking about more things to add.

### [american defense alliance site](https://www.americandefensealliance.org)
